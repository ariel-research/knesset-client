export const billsSelectionHeaders = {
  header: "שקיפות בכנסת",
  hint: "שירות זה נועד כדי לספק לציבור בישראל אפשרות להשוות בין דעותיהם הפוליטיות להצבעות חברי כנסת ישראל",
  loadBillsButton: "טען הכל",
...
export const selectedBillsTable = {
  title: "הצבעות שנבחרו",
};
